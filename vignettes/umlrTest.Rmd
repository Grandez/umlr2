...
|:-:|:-:|:-:|
| `r eval = LOCAL, plant$plotClass(c0, UMLShow$basic)`|`r eval = LOCAL, plant$plotClass(c0, UMLShow$simple)`|`r eval = LOCAL, plant$plotClass(c0, UMLShow$complete)`|
...
| basic  | simple | complete |
|:-:|:-:|:-:|
|`r eval = LOCAL, plant$plotClass(c01, UMLShow$basic)`|`r eval = LOCAL, plant$plotClass(c01, UMLShow$simple)`|`r eval = LOCAL, plant$plotClass(c01, UMLShow$complete)`|
...
|:-:|:-:|:-:|
|`r eval = LOCAL, plant$plotClass(c01, base)`|`r eval = LOCAL, plant$plotClass(c01, c(base,UMLShow$classSimple))`|`r eval = LOCAL, plant$plotClass(c01,c(base,UMLShow$classComplete))`|
...
```
```{r eval = LOCAL, echo=FALSE, fig.cap = "classBasic" }
 plant$plotClass(c1, base)
``` 
```{r eval = LOCAL, echo=FALSE, fig.cap="classSimple" }
 plant$plotClass(c1, c(base,UMLShow$classSimple))
```
```{r eval = LOCAL, echo=FALSE, fig.cap="classComplete" }
